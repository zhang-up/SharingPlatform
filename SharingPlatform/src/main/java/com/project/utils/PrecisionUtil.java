...
public class PrecisionUtil {
	...
	public static String mulToStr(double v1, double v2){
		 return String.valueOf(mul(v1,v2));
	}
	...
	public static String divToStr(double v1, double v2, int scale){
		 return String.valueOf(div(v1,v2,scale));
	}
	...
	public static int doubleToInt(double d){
		Double re = new Double(round(d,0));
		return re.intValue();
	}
	...
	public static String formatdb(double d,int scale){
		 return String.valueOf(round(d,scale));
	}
	 ...
	 * @param val1
	 * @param val2
	 * @return 1:第一个参数大    0:一样大    -1:第二个参数大
	 */
